...
public class AbsenActivity extends AppCompatActivity {
    ...
    public static final String URL = "http://yukabsen.000webhostapp.com/";
    private RadioButton radioSexButton;
    private ProgressDialog progress;


    @BindView(R.id.radioSesi) RadioGroup radioGroup;
    @BindView(R.id.editTextNoAbsn) EditText editTextNoAbsn;
    @BindView(R.id.editTextNama) EditText editTextNama;
    @BindView(R.id.editTextKelas) EditText editTextKelas;
    @BindView(R.id.editTextKet) EditText editTextKet;
    ...
    @OnClick(R.id.buttonDaftar) void daftar() {
        ...
        String noabsn = editTextNoAbsn.getText().toString();
        ...
        Call<Value> call = api.daftar(noabsn, nama, kelas, sesi, ket);
        call.enqueue(new Callback<Value>() {
            ...
            public void onFailure(Call<Value> call, Throwable t) {
                progress.dismiss();
                Toast.makeText(AbsenActivity.this, "Jaringan Error!", Toast.LENGTH_SHORT).show();
            }
        });
    }

    @OnClick(R.id.buttonLihat) void lihat() {
        startActivity(new Intent(AbsenActivity.this, ViewActivity.class));
    }
